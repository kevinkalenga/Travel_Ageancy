                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                 ...
                                                 <div>
                                                    <img class="w_100" src="{{asset('uploads/'.$package->featured_photo)}}" alt="">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                  ...
                                                  <div>
                                                    <img class="w_100" src="{{asset('uploads/'.$package->banner)}}" alt="">
                                                  </div>
                                                </div>
                                                <div class="mb-3">
                                                     ...
                                                     <select name="destination_id" class="form-select">
                                                        @foreach($destinations as $destination)
                                                            <option value="{{ $destination->id }}" 
                                                                @if($package->destination_id == $destination->id) selected @endif>
                                                                {{ $destination->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
